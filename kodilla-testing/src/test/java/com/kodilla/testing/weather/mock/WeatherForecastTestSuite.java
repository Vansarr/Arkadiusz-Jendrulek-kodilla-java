...
import com.example.kodillatesting.weather.stub.*;
...
class WeatherForecastTestSuite {
    ...
    void testCalculateAverageWithMock() {
        ...
        WeatherForecast weatherForecast = new WeatherForecast(temperaturesMock);
        //When
        double averageTemperatures = weatherForecast.calculateAverageTemperatures();
    ...
    void testCalculateMedianWithMock() {
        ...
        //Then
        Assertions.assertEquals(25.5, temperaturesMedian);
    }
